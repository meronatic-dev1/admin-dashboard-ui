                ...
                <div style={{ width: '100%', maxWidth: '400px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    <div style={{ marginBottom: '28px', width: '100%' }}>
                        ...
                        <div style={{
                            ...
                            <span style={{ fontSize: 10, fontWeight: 800, color: '#2563eb', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
                                🔐 Restricted Access
                            </span>
                        </div>
                    ...
                    <form onSubmit={(e) => { e.preventDefault(); window.location.href='/admin'; }} style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '16px', background: '#1a1a24', padding: '24px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.08)' }}>
                        <div>
                            <label style={{ display: 'block', color: 'rgba(255,255,255,0.9)', fontSize: '13px', marginBottom: '8px' }}>Email address</label>
                            <input type="email" value={email} onChange={e => setEmail(e.target.value)} style={{ width: '100%', padding: '12px', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', color: '#fff', boxSizing: 'border-box' }} required />
                        </div>
                        <div>
                            <label style={{ display: 'block', color: 'rgba(255,255,255,0.9)', fontSize: '13px', marginBottom: '8px' }}>Password</label>
                            <input type="password" value={password} onChange={e => setPassword(e.target.value)} style={{ width: '100%', padding: '12px', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', color: '#fff', boxSizing: 'border-box' }} required />
                        </div>
                        <button type="submit" style={{ width: '100%', padding: '12px', background: '#2563eb', color: '#fff', border: 'none', borderRadius: '8px', fontSize: '14px', fontWeight: 600, cursor: 'pointer', marginTop: '8px' }}>Continue</button>
                    </form>
