...
const MODE_COLORS: Record<string, { color: string; icon: React.ReactNode }> = {
    Delivery: { color: "#2563eb", icon: <Bike size={20} /> },
...
export default function AdminOverviewPage() {
    ...
    const kpis = data ? [
        { label: "Revenue", value: `AED ${data.kpis.revenue.toLocaleString('en-US', { minimumFractionDigits: 0 })}`, icon: DollarSign, color: "#2563eb", glow: "rgba(37,99,235,0.15)" },
    ...
    return (
        <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1, maxWidth: 1200, padding: "0 4px" }}>
                ...
                {loading ? (
                    <div style={{ textAlign: 'center', padding: '80px 0', color: 'rgba(0,0,0,0.25)', fontSize: 14 }}>
                        Loading dashboard…
                    </div>
                ) : !data ? (
                    <div style={{ textAlign: 'center', padding: '80px 0', color: 'rgba(0,0,0,0.25)', fontSize: 14 }}>
                    ...
                    <>
                        ...
                        <div style={{
                            ...
                            {kpis.map((k, i) => (
                                ...
                                >
                                    ...
                                    <p style={{ fontSize: 24, fontWeight: 800, margin: "0 0 10px", letterSpacing: "-0.04em", color: "#0f172a" }}>
                                        {k.value}
                                    </p>
                                </div>
                            ))}
                        ...
                        <div style={{
                            ...
                            {data.modeSplit.map((m, i) => {
                                const cfg = MODE_COLORS[m.label] || { color: "#2563eb", icon: <Bike size={20} /> };
                                return (
                                    <div key={m.label} style={{
                                        ...
                                        <div style={{ flex: 1, minWidth: 0 }}>
                                            ...
                                            <p style={{ fontSize: 11, color: "rgba(0,0,0,0.25)", margin: "5px 0 0" }}>
                                                {m.count} orders
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                                        ...
                                        <span style={{ fontSize: 13, fontWeight: 700, color: "#0f172a" }}>Recent Orders</span>
                                    </div>
                                ...
                                {data.recentOrders?.length === 0 ? (
                                    <div style={{ textAlign: 'center', padding: '40px 0', color: 'rgba(0,0,0,0.15)', fontSize: 13 }}>
                                        No orders yet.
                                    </div>
                                    ...
                                    <div key={o.id + i} style={{
                                        ...
                                        padding: "13px 20px",
                                        borderBottom: i < (data.recentOrders?.length ?? 0) - 1 ? "1px solid rgba(0,0,0,0.04)" : "none",
                                    ...
                                    >
                                        ...
                                        <div style={{ flex: 1, minWidth: 0 }}>
                                            ...
                                            <span style={{ fontSize: 11, color: "rgba(0,0,0,0.35)" }}>{o.branch}</span>
                                        </div>

                                        <div style={{ textAlign: "right", flexShrink: 0 }}>
                                            <p style={{ fontSize: 14, fontWeight: 800, color: "#0f172a", margin: "0 0 4px", letterSpacing: "-0.02em" }}>
                                                {o.total}
                                            </p>
                            ...
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                                        <div style={{
                                            ...
                                            <Flame size={13} style={{ color: "#2563eb" }} />
                                        </div>
                                        <span style={{ fontSize: 13, fontWeight: 700, color: "#0f172a" }}>Top Products</span>
                                    </div>
                                ...
                                <div style={{ padding: "16px 20px", display: "flex", flexDirection: "column", gap: 18 }}>
                                    {data.topProducts?.length === 0 ? (
                                        <div style={{ textAlign: 'center', padding: '30px 0', color: 'rgba(0,0,0,0.15)', fontSize: 13 }}>
                                            No product data yet.
                                        </div>
                                        ...
                                        <div key={p.name}>
                                            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 7 }}>
                                                ...
                                                <span style={{ fontSize: 12, color: "rgba(0,0,0,0.25)", flexShrink: 0, marginLeft: 8, fontWeight: 600 }}>
                                                    {p.orders}
                                                </span>
                                            </div>
                                            <div style={{
                                                ...
                                                <div style={{
                                                    ...
                                                    background: i === 0
                                                        ...
                                                        : `rgba(37,99,235,${0.7 - i * 0.12})`,
                                                    width: `${p.pct}%`,
                                                    boxShadow: i === 0 ? "0 0 8px rgba(37,99,235,0.6)" : "none",
                                ...
                                <div style={{
                                    ...
                                    <span style={{ fontSize: 11, color: "rgba(0,0,0,0.25)", fontWeight: 600, letterSpacing: "0.04em" }}>
                                        TOTAL ITEMS SOLD
                                    </span>
                                    <span style={{ fontSize: 15, fontWeight: 800, color: "#2563eb", letterSpacing: "-0.02em" }}>
