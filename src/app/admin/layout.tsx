...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    const isLoaded = true;
    const user = { publicMetadata: { role: 'admin', branchId: undefined }, firstName: 'Admin', emailAddresses: [{ emailAddress: 'admin@meronatic.com' }] };
    ...
    // Placeholder branches for UI
    const branches: ApiLocation[] = [];
            ...
            <aside style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <img
                            src="/meronatic-logo.jpg"
                            alt="Meronatic Logo"
                            style={{ width: '100%', height: '100%', objectFit: 'contain', padding: 1 }}
                        />
                    </div>
                    <div>
                        <p style={{ fontSize: 14, fontWeight: 800, margin: 0, letterSpacing: '-0.03em', color: '#0f172a' }}>
                            Meronatic
                        </p>
                        <p style={{ fontSize: 9, color: 'rgba(37,99,235,0.7)', margin: 0, letterSpacing: '0.14em', textTransform: 'uppercase', fontWeight: 700 }}>
                            Admin Console
                        </p>
                    </div>
                </div>
                ...
                <div style={{ padding: '20px 20px 8px' }}>
                    <p style={{
                        ...
                        textTransform: 'uppercase', color: 'rgba(15,23,42,0.3)', margin: 0,
                    }}>
                        Main Menu
                    </p>
                </div>
                        ...
                        return (
                            <Link
                                ...
                                style={{
                                    ...
                                    textDecoration: 'none',
                                    color: active ? '#2563eb' : 'rgba(15,23,42,0.5)',
                            ...
                            >
                                ...
                                <Icon
                                    size={15}
                                    style={{ color: active ? '#2563eb' : 'rgba(15,23,42,0.4)', flexShrink: 0 }}
                                />
                                {label}
                                {/* Active dot */}
                                {active && (
                ...
                <div style={{
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                        <p style={{ fontSize: 12, fontWeight: 700, color: '#0f172a', margin: 0, letterSpacing: '-0.01em', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                            {isLoaded ? (user?.firstName || user?.emailAddresses[0]?.emailAddress || 'User') : 'Loading...'}
                        </p>
                        <p style={{ fontSize: 10, color: 'rgba(15,23,42,0.4)', margin: 0, textTransform: 'capitalize' }}>
                            {userRole.replace('_', ' ')}
                        </p>
                    </div>
                    <button
                        ...
                        style={{ 
                            ...
                            color: 'rgba(15,23,42,0.3)', lineHeight: 0, transition: 'color 0.15s' 
                        }}
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0, position: 'relative', zIndex: 1 }}>
                ...
                <header style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        <span style={{ fontSize: 12, color: 'rgba(15,23,42,0.3)', fontWeight: 500 }}>Dashboard</span>
                        <span style={{ fontSize: 12, color: 'rgba(15,23,42,0.12)' }}>/</span>
                        ...
                        <div ref={notifRef} style={{ position: 'relative' }}>
                            <button
                                ...
                                style={{
                                    ...
                                    width: 36, height: 36,
                                    borderRadius: 9,
                                    background: showNotifDropdown ? 'rgba(0,0,0,0.05)' : '#fff',
                                    border: `1px solid ${showNotifDropdown ? 'rgba(0,0,0,0.15)' : 'rgba(0,0,0,0.1)'}`,
                                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                                    color: showNotifDropdown ? '#2563eb' : 'rgba(15,23,42,0.4)',
                                    cursor: 'pointer',
                                    ...
                                    <div style={{ maxHeight: 320, overflowY: 'auto' }}>
                                        {notifications.length === 0 ? (
                                            <div style={{ padding: '32px 16px', textAlign: 'center' }}>
                                                <Bell size={24} style={{ color: 'rgba(0,0,0,0.1)', marginBottom: 8 }} />
                                                <p style={{ fontSize: 12, color: 'rgba(0,0,0,0.25)', margin: 0 }}>
                                            ...
                                            notifications.map((notif, idx) => (
                                                ...
                                                >
                                                    ...
                                                    <span style={{ fontSize: 10, color: 'rgba(0,0,0,0.3)', flexShrink: 0, fontWeight: 600 }}>
